...
#ifndef WICED_MEMORY_H__
#define WICED_MEMORY_H__

#include "wiced_bt_types.h"
#include "wiced_gki.h"

/**
 * \addtogroup group_memory Memory Management
 * \ingroup wicedsys
 * \{
 *
 ...
 * the app note /doc/WICED-Application-Buffer-Pools.pdf
 *
 * \defgroup group_memory_functions Functions
 * \defgroup group_memory_data_structures Data Structures
 */
...
/**
 * \addtogroup group_memory_data_structures
 * \{
 */
...
/******************************************************************************
 * Function Name: wiced_bt_buffer_poolutilization
 ***************************************************************************//**
 *
 * Get specific buffer pool utilization
 *
 * \param size
 * Parameters       pool_id - (input) pool ID
 *
 * \return
...
/******************************************************************************
 * Function Name: wiced_memory_get_free_bytes
 ***************************************************************************//**
 *
...
/******************************************************************************
 * Function Name: wiced_bt_get_buffer_from_pool
 ***************************************************************************//**
 *
 * Allocates a buffer from the private pool. Pass the pool pointer to get the
 * buffer from the desired pool.
 *
 * \param p_pool
 * The pointer to the created pool
 *
 * \return
 * The pointer to the buffer on success
 * NULL on failure
 *
 ******************************************************************************/
...
/******************************************************************************
 * Function Name: wiced_bt_get_buffer_count
 ***************************************************************************//**
 *
...
/******************************************************************************
 * Function Name: wiced_bt_get_buffer
 ***************************************************************************//**
 *
...
/******************************************************************************
 * Function Name: wiced_bt_free_buffer
 ***************************************************************************//**
 *
 * Frees an existing buffer in a pool.
 *
 * \param p_buf
 * The pointer to the start of the buffer to be freed
 *
 * \return void
 *
 ******************************************************************************/
...
/******************************************************************************
 * Function Name: wiced_bt_get_buffer_size
 ***************************************************************************//**
 *
 ...
 *
 * \return
 * The size of the buffer on success
 * 0 if unsuccessful
 *
 ******************************************************************************/
...
/******************************************************************************
 * Function Name: wiced_bt_get_buffer_usage
 ***************************************************************************//**
 *
 * Dumps dynamic buffer usage (see #wiced_bt_buffer_statistics_t),from the last start of the system.
 *
 * \param p_buffer_stat
 * The pointer buffer to fill statistics
 *
 * \param size
 * The size of the memory to get the statistics
 *
 * \return
...
/** \} group_memory_functions */

#endif // WICED_MEMORY_H__
