...
#ifndef WICED_BT_DEV_H__
#define WICED_BT_DEV_H__
...
enum wiced_bt_management_evt_e
{
    ...
    BTM_PAIRING_IO_CAPABILITIES_BLE_REQUEST_EVT,                               /**< Requesting IO capabilities for LE pairing. Peripheral can check peer io capabilities in event data before updating with local io capabilities. Event data:
 ...
 *                                   between Bluetooth and WLAN chip. The maximum supported
 *                                   value is up to 4M.
 *
 * \return          wiced_result_t
 *
