 ...
 *
 * \brief
 *   Contains the definitions for the SDP API.
 *
 *//*****************************************************************************
...
/* Defines the PSM that SDP uses */
#define SDP_PSM     0x0001

/* Legacy define to avoid code changes - SDP UUID is the same as Bluetooth UUID. */
...
/* Defines a callback function used after a discovery result is completed. */
...
/* Defines a callback function used after a discovery result is received. */
typedef void (tSDP_DISC_RES_CB) (UINT16 event, tSDP_DATA *p_data);

/* Defines a structure to hold the discovered service information. */
typedef struct
{
    union
    {
...
typedef struct
{
    UINT16 protocol_uuid;                           /* Protocol UUID */
...
/******************************************************************************
 *
 * Function Name:        SDP_InitDiscoveryDb
 *
 ***************************************************************************//**
 *
 *    Called to initialize a discovery database.
 *
...
/******************************************************************************
 *
 * Function Name:         SDP_CancelServiceSearch
 *
 ***************************************************************************//**
 *
 *       Cancels an active query to an SDP server.
 *
 ...
 ***************************************************************************//**
 *
 *       Queries an SDP server for information.
 *
...
/******************************************************************************
 *
 * Function Name:         SDP_FindAttributeInDb
 *
 ***************************************************************************//**
 *
 *                  Queries an SDP database for a specific attribute.
...
/******************************************************************************
 *
 * Function Name:         SDP_FindAttributeInRec
 *
 ***************************************************************************//**
 *
 *                  This function searches an SDP discovery record for a
 *                  specific attribute.
 *
...
/******************************************************************************
 *
 * Function Name:         SDP_FindServiceInDb
 *
 ***************************************************************************//**
 *
 *                  Queries an SDP database for a specific service.
 *                  If the p_start_rec pointer is NULL, it looks from the beginning
 *                  of the database, else it continues from the next record after
 *                  p_start_rec.
 *
 * \return          Pointer to record containing service class, or NULL
 *
 ******************************************************************************/
...
/******************************************************************************
 *
 * Function Name:         SDP_FindServiceUUIDInDb
 *
 ***************************************************************************//**
 *
 *                  Queries an SDP database for a specific service.
...
/******************************************************************************
 *
 * Function Name:         SDP_FindProtocolListElemInRec
 *
 ***************************************************************************//**
 *
 *                  Looks at a specific discovery record for a
...
/******************************************************************************
 *
 * Function Name:         SDP_FindAddProtoListsElemInRec
 *
 ***************************************************************************//**
 *
 *                  Looks at a specific discovery record for a
...
/******************************************************************************
 *
 * Function Name:         SDP_FindProfileVersionInRec
 *
 ***************************************************************************//**
 *
 *                  Looks at a specific discovery record for the
 ...
 ***************************************************************************//**
 *
 *                  Called to create a record in the database.
...
/******************************************************************************
 *
 * Function Name:         SDP_DeleteRecord
 *
 ***************************************************************************//**
 *
 *                  Called to add a record (or all records)
...
/******************************************************************************
 *
 * Function Name:         SDP_ReadRecord
 *
 ***************************************************************************//**
 *
 *                  Called to get the raw data of the record
...
/******************************************************************************
 *
 * Function Name:         SDP_AddSequence
 *
 ***************************************************************************//**
 *
 *                  Called to add a sequence to a record.
 *                  This would be through the SDP database maintenance API.
...
/******************************************************************************
 *
 * Function Name:         SDP_AddUuidSequence
 *
 ***************************************************************************//**
 *
 *                  Called to add a UUID sequence to a
...
/**************************************************************************//**
 *
 * Function Name:         SDP_AddProtocolList
 *
 ***************************************************************************//**
 *
 *                  Called to add a protocol descriptor list
...
/******************************************************************************
 *
 * Function Name:         SDP_AddAdditionProtoLists
 *
 ***************************************************************************//**
 *
 *                  Called to add a protocol descriptor list to
...
/******************************************************************************
 *
 * Function Name:         SDP_AddProfileDescriptorList
 *
 ***************************************************************************//**
 *
 *       This function is called to add a profile descriptor list to
 *                  a record. This would be through the SDP database maintenance API.
...
/******************************************************************************
 *
 * Function Name:         SDP_AddLanguageBaseAttrIDList
 *
 ***************************************************************************//**
 *
 *                  Called to add a language base attr list to
 *                  a record. This would be through the SDP database maintenance API.
 *                  If the version already exists in the record, it is replaced
 *                  with the new one.
 *
...
/******************************************************************************
 *
 * Function Name:         SDP_AddServiceClassIdList
 *
 ***************************************************************************//**
 *
 *                  Called to add a service list to a
...
/******************************************************************************
 *
 * Function Name:         SDP_DeleteAttribute
 ***************************************************************************//**
 *
 *                  Called to delete an attribute from a record.
 *                  This would be through the SDP database maintenance API.
 *
 * \return           TRUE if deleted OK, else FALSE if not found
 *
 ******************************************************************************/
...
/******************************************************************************
 *
 * Function Name:         SDP_SetLocalDiRecord
 *
 ***************************************************************************//**
 *
 *                 Adds a DI record to the local SDP database.
 *
 * \return          Returns SDP_SUCCESS if record added successfully, else error
 *
 ******************************************************************************/
...
/******************************************************************************
 *
 * Function Name:         SDP_GetLocalDiRecord
 *
 ***************************************************************************//**
 *
 *                  Adds a DI record to the local SDP database.
 ...
 *
 * \return          Returns SDP_SUCCESS if record exists, else error
 *
 ******************************************************************************/
...
/******************************************************************************
 *
 * Function Name:         SDP_DiDiscover
 *
 ***************************************************************************//**
 *
 *       Queries a remote device for DI information.
 *
 * \return          SDP_SUCCESS if query started successfully, else error
 *
 ******************************************************************************/
...
/******************************************************************************
 *
 * Function Name:         SDP_GetNumDiRecords
 *
 ***************************************************************************//**
 *
 *       Searches specified database for DI records
 *
 * \return          The number of DI records found.
 *
 ******************************************************************************/
...
/******************************************************************************
 *
 * Function Name:         SDP_GetDiRecord
 *
 ***************************************************************************//**
 *
 *                 Retrieves a remote device's DI record from
 *                 the specified database.
 *
 * \return         SDP_SUCCESS if record retrieved, else error
 *
 ******************************************************************************/
...
/******************************************************************************
 *
 * Function Name:         SDP_SetTraceLevel
 *
 ***************************************************************************//**
 *
 *             Sets the trace level for SDP. If called with
...
/******************************************************************************
 *
 * Function Name:         SDP_ConnOpen
 *
 ***************************************************************************//**
 *
 *       Creates a connection to the SDP server on the
 *                  given device.
 *
 * \return          0, if failed to initiate connection. Otherwise, the handle.
 *
 ******************************************************************************/
...
/******************************************************************************
 *
 * Function Name:         SDP_WriteData
 *
 ***************************************************************************//**
 *
 *                  Sends data to the connected SDP server.
 *
 * \return          TRUE if data is sent, FALSE if failed.
 *
 ******************************************************************************/
...
/******************************************************************************
 *
 * Function Name:         SDP_ConnClose
 *
 ***************************************************************************//**
 *
 *       Called to close an SDP connection.
 *
 * \param      handle      - Handle of the connection returned by SDP_ConnOpen
 *
 * \return          TRUE if connection is closed, FALSE if failed to find the handle.
 *
 ******************************************************************************/
...
/******************************************************************************
 *
 * Function Name:         SDP_FindServiceUUIDInRec
 *
 ***************************************************************************//**
 *
 *                  Called to read the service UUID within a record
 *                  if there is any.
 *
 * \param      p_rec      - The pointer to an SDP record.
 *
