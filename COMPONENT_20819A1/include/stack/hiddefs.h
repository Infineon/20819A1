...
*
* \brief
*   Contains HID protocol definitions.
*
*
*//*****************************************************************************
...
typedef struct sdp_info
{
    ...
    UINT16    ssr_max_latency;             /* HIDSSRHostMaxLatency value, if HID_SSR_PARAM_INVALID is not used */
    UINT16    ssr_min_tout;                /* HIDSSRHostMinTimeout value, if HID_SSR_PARAM_INVALID is not used */
    UINT8     sub_class;                   /* D evice Subclass */
