...
#if !(defined WICEDX) && !(defined WIN32) && !(defined __ANDROID__) && !(defined __APPLE__)
...
#define SYNTH_TX                1           /* Wants synth code to TRANSMIT at this freq */
#define SYNTH_RX                2           /* Wants synth code to RECEIVE at this freq */

#define SYNC_REPS 1             /* Repeats sync word transmitted to start of burst */
...
#define TRACE_LAYER_GKI             0x00160000 /* It is overwritten in nfc_types.h */
...
#define TRACE_LAYER_NCI             0x00230000 /* It is overwritten in nfc_types.h */
...
#define TRACE_LAYER_HAL             0x002c0000 /* It is overwritten in nfc_types.h */
