...
*
* \brief
*   Contains L2CAP protocol definitions.
*
*
*//*****************************************************************************
...
#define L2CAP_CFG_FLUSH_OPTION_LEN      2           /* Flush option length */
...
/* Defines a value that tells L2CAP to use the default HCI ACL buffer pool. */
#define L2CAP_DEFAULT_ERM_POOL_ID       0xFF
/* Defines a value that tells L2CAP to use the default MPS. */
